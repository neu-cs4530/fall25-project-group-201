...
describe('Question model', () => {
  ...
  describe('downloadQuestionMedia', () => {
    test('downloadQuestionMedia should return the mediaPath when question exists and download is permitted', async () => {
      const mockQuestion = {
      ...
      const result = await downloadQuestionMedia('68f0589f28fdad025905af9b');

      expect(result).toBe('/uploads/media/test-file.jpg');
      expect(QuestionModel.findById).toHaveBeenCalledWith('68f0589f28fdad025905af9b');
    });

    test('downloadQuestionMedia should return error object when question is not found', async () => {
    ...
    test('downloadQuestionMedia should return error object when question has no mediaPath', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
    ...
    test('downloadQuestionMedia should return error object when permitDownload is undefined', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
    ...
    test('downloadQuestionMedia should return error object when permitDownload is false', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
  ...
  describe('toggleQuestionMediaPermission', () => {
    test('toggleQuestionMediaPermission should return true when toggling from false to true', async () => {
      ...
      jest.spyOn(QuestionModel, 'findById').mockResolvedValue(mockQuestion);
      jest.spyOn(QuestionModel, 'findByIdAndUpdate').mockResolvedValue(mockUpdatedQuestion);

      const result = await toggleQuestionMediaPermission('68f0589f28fdad025905af9b', 'testuser');
    ...
    test('toggleQuestionMediaPermission should return false when toggling from true to false', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
    ...
    test('toggleQuestionMediaPermission should return error object when question is not found', async () => {
      jest.spyOn(QuestionModel, 'findById').mockResolvedValue(null);
    ...
    test('toggleQuestionMediaPermission should return error object when username does not match askedBy', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
        askedBy: 'originaluser',
        askDateTime: new Date(),
        mediaPath: '/uploads/media/test-file.jpg',
        permitDownload: true,
      };
    ...
    test('toggleQuestionMediaPermission should return error object when question has no mediaPath', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
    ...
    test('toggleQuestionMediaPermission should return error object when question has no permitDownload', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
    ...
    test('toggleQuestionMediaPermission should return error object when both mediaPath and permitDownload are undefined', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
    ...
    test('toggleQuestionMediaPermission should return error object when findByIdAndUpdate returns null', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
    ...
    test('toggleQuestionMediaPermission should return error object when updatedQuestion has undefined permitDownload', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
    ...
    test('toggleQuestionMediaPermission should return error object when findById throws an error', async () => {
    ...
    test('toggleQuestionMediaPermission should return error object when findByIdAndUpdate throws an error', async () => {
      const mockQuestion = {
        _id: '68f0589f28fdad025905af9b',
        title: 'Test Question',
        text: 'Test content',
      ...
      jest.spyOn(QuestionModel, 'findById').mockResolvedValue(mockQuestion);
      jest.spyOn(QuestionModel, 'findByIdAndUpdate').mockRejectedValue(new Error('Update failed'));
